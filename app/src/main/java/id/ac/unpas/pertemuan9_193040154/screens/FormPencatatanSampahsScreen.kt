...
import id.ac.unpas.pertemuan9_193040154.ui.theme.Teal200
import kotlinx.coroutines.launch

@Composable
fun FormPencatatanSampah(navController: NavController, id:String? = null,
modifier: Modifier)
{
    ...
    Column(modifier = Modifier
        ...
        OutlinedTextField(
            ...
            value = berat.value, onValueChange = {
                berat.value = it
            },
            modifier = Modifier
                .padding(4.dp)
        ...
        val resetButtonColors = ButtonDefaults.buttonColors( backgroundColor = Teal200,
                ...
                if (id != null) {
                    LaunchedEffect(scope) {
                        viewModel.loadItem(id) {
                           setoranSampah ->  setoranSampah?.let {
                               tanggal.value = TextFieldValue(setoranSampah.tanggal)
