package id.ac.unpas.pertemuan9_193040154.repositories
...
import id.ac.unpas.pertemuan9_193040154.networks.SetoranSampahApi
import id.ac.unpas.pertemuan9_193040154.persistences.SetoranSampahDao
...
class SetoranSampahRepository @Inject constructor(
    ...
    suspend fun loadItems(
        ...
        // handle the case when the API request gets an exception responses.
    ...
    suspend fun delete(id: String, onSuccess: () -> Unit, onError: (String) -> Unit) {
        dao.delete(id)
        api.delete(id)
        // handle the case when the API request gets an success response.
            .suspendOnSuccess {
                data.whatIfNotNull {
                    onSuccess()
                }
